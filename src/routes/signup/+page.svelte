	...
	<div class="w-full max-w-md rounded-4xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-3xl">
		...
		<div class="space-y-6">
			<div class="grid grid-cols-4 gap-2">
				<button aria-label="Sign in with github" onclick={() => handleSocialSignup('github')} type="button" class="flex justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-white transition-all hover:bg-[#24292e] active:scale-[0.98]"
					><span class="size-5"
				...
				<button aria-label="Sign In with google" onclick={() => handleSocialSignup('google')} type="button" class="flex justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-white transition-all hover:bg-white/10 active:scale-[0.98]">
				...
				<button aria-label="Sign in with discord" onclick={() => handleSocialSignup('discord')} type="button" class="flex justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-white transition-all hover:bg-white/10 active:scale-[0.98]">
					<span class="size-5"
				...
				<button aria-label="Sign in with roblox" onclick={() => handleSocialSignup('roblox')} type="button" class="flex justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-white transition-all hover:bg-white/10 active:scale-[0.98]">
					<span class="size-5">
