	...
	<div class="w-full max-w-md rounded-4xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-3xl">
		...
		<div class="space-y-6">
			<div class="grid grid-cols-4 gap-2">
				...
				<button onclick={() => handleSocialSignup('discord')} type="button" class="flex justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-white transition-all hover:bg-white/10 active:scale-[0.98]">
					<span class="size-5"
				...
				<button onclick={() => handleSocialSignup('roblox')} type="button" class="flex justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-white transition-all hover:bg-white/10 active:scale-[0.98]">
					<span class="size-5">
