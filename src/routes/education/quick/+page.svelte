<script>
    ...
    function highlightCode(line) {
        ...
        hl = hl.replace(/\b(arr|n|i|j|low|high|pivot|pi|temp)\b/g, '<span class="syntax-variable">$1</span>');
    ...
    function generateStates() {
        ...
        function qs(low, high) {
            ...
            if (low < high) {
                ...
                newStates.push({ arr: [...tempArr], line: 3, comparing: [high], swapping: [], sorted: [...fullySorted] });
                
                let i = low - 1;
                newStates.push({ arr: [...tempArr], line: 4, comparing: [high], swapping: [], sorted: [...fullySorted] });
                
                newStates.push({ arr: [...tempArr], line: 5, comparing: [high], swapping: [], sorted: [...fullySorted] });
                for (let j = low; j < high; j++) {
                    newStates.push({ arr: [...tempArr], line: 6, comparing: [high, j], swapping: [], sorted: [...fullySorted] });
                    
                    if (tempArr[j] < pivot) {
                        i++;
                        newStates.push({ arr: [...tempArr], line: 7, comparing: [high], swapping: [], sorted: [...fullySorted] });
                        
                        let temp = tempArr[i];
                        tempArr[i] = tempArr[j];
                        tempArr[j] = temp;
                        newStates.push({ arr: [...tempArr], line: 8, comparing: [], swapping: [i, j], sorted: [...fullySorted] });
                        newStates.push({ arr: [...tempArr], line: 9, comparing: [], swapping: [i, j], sorted: [...fullySorted] });
                        newStates.push({ arr: [...tempArr], line: 10, comparing: [], swapping: [i, j], sorted: [...fullySorted] });
                        newStates.push({ arr: [...tempArr], line: 11, comparing: [], swapping: [], sorted: [...fullySorted] });
                    }
                    newStates.push({ arr: [...tempArr], line: 12, comparing: [], swapping: [], sorted: [...fullySorted] });
                }
                
                let temp = tempArr[i + 1];
                tempArr[i + 1] = tempArr[high];
                tempArr[high] = temp;
                newStates.push({ arr: [...tempArr], line: 13, comparing: [], swapping: [i+1, high], sorted: [...fullySorted] });
                newStates.push({ arr: [...tempArr], line: 14, comparing: [], swapping: [i+1, high], sorted: [...fullySorted] });
                newStates.push({ arr: [...tempArr], line: 15, comparing: [], swapping: [i+1, high], sorted: [...fullySorted] });
...
<main class="main">
    ...
    <header class="header">
        <div class="line"></div>
        <h1 class="text-4xl font-black text-white uppercase">Quick Sort</h1>
        <p>Quick Sort เป็นอัลกอริทึมการเรียงลำดับแบบ Divide and Conquer (แบ่งแยกและเอาชนะ) ที่มีประสิทธิภาพสูงลิ่ว เริ่มโดยการเลือกค่า Pivot ขึ้นมาหนึ่งค่า แล้วสลับข้อมูลทั้งหมดที่น้อยกว่า Pivot ไปไว้ฝั่งซ้าย และมากกว่าไว้ฝั่งขวา จากนั้นจึงนำกฎเดียวกันนี้ไปวนซ้ำ (Recursion) กับอาร์เรย์ฝั่งซ้ายและขวา ด้วยพฤติกรรมนี้ทำให้มันสามารถเรียงลำดับเสร็จสิ้นได้อย่างรวดเร็วจนถูกนำมาใช้เป็นฟังก์ชันมาตรฐานในเกือบทุกภาษาโปรแกรม</p>
    </header>
    <!-- Grid -->
    <div class="layout">
        <!-- Left -->
        <section class="left">
            ...
            <div class="glass">
                <p>Quick Sort ทำงานได้เร็วมากในสถานการณ์จริง (O(n log n)) แต่ถ้าข้อมูลสุ่มมาแบบเรียงลำดับอยู่แล้วและเลือก Pivot แย่ อาจทำให้ทำงานช้าลงไปเป็น O(n²) ได้</p>
            </div>
        </section>
                    ...
                    <div class="protocol-grid">
                        <div class="protocol-item">
                            ...
                            <div class="protocol-content">
                                <h4>Pivot Selection</h4>
                                <p>เลือกสมาชิกตัวใดตัวหนึ่งในอาร์เรย์มาเป็นหลัก (Pivot) ในกรณีนี้เราใช้ตัวขวาสุดของแต่ละรอบ</p>
                            </div>
                        </div>
                        <div class="protocol-item">
                            ...
                            <div class="protocol-content">
                                <h4>Partitioning</h4>
                                <p>เปรียบเทียบข้อมูลที่เหลือกับ Pivot จัดกลุ่มค่าน้อยกว่าไว้ซ้าย ค่ามากกว่าไว้ขวา</p>
                            </div>
                        </div>
                        <div class="protocol-item">
                            ...
                            <div class="protocol-content">
                                ...
                                <p>แยกย่อยข้อมูลเป็น 2 ส่วน (ซ้ายและขวาของ Pivot) และส่งเข้าไปทำซ้ำแบบเดียวกันจนกว่าจะเหลือ 1 ช่อง</p>
                            </div>
                        </div>
                        <div class="protocol-item">
                            ...
                            <div class="protocol-content">
                                <h4>Instability</h4>
                                <p>Quick Sort มีการสลับที่ข้อมูลข้ามกันไปมาอย่างรวดเร็ว ทำให้ไม่ใช่ Stable Sort</p>
                            </div>
                        </div>
                    </div>
            </div>
